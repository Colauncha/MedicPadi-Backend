...
export class OrderController {
  ...
  @ApiOperation({
    ...
    description: 'Returns a paginated list of appointments. Results are scoped to the authenticated user. Accessible by `patient`, `consultant`, and `admin` roles.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Returns a single appointment. The response detail level may differ by role. Accessible by `patient`, `consultant`, and `admin` roles.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Updates appointment details such as time, status, or meeting link. Accessible by `patient`, `consultant`, and `admin` roles.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Cancels (removes) an appointment. Accessible by `patient`, `consultant`, and `admin` roles.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Issues a prescription for a patient following a consultation. Accessible by `consultant` and `admin` roles.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Returns a paginated list of prescriptions. Accessible by `patient`, `consultant`, `pharmacy`, and `admin` roles.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Returns a single prescription. Accessible by `patient`, `consultant`, `pharmacy`, and `admin` roles.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Updates prescription details (e.g. dispensing status). Accessible by `consultant`, `pharmacy`, and `admin` roles.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Removes a prescription. Accessible by `consultant` and `admin` roles.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Submits a request to purchase drugs from a pharmacy, typically linked to a prescription. Accessible by `patient` and `admin` roles.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Returns a paginated list of drug requisitions. Accessible by `patient`, `pharmacy`, `consultant`, and `admin` roles.',
  })
  @ApiResponse({ status: 200, description: 'Paginated list of drug requisitions.' })
  @ApiResponse({ status: 401, description: 'Missing or invalid token.' })
  ...
  @ApiOperation({
    ...
    description: 'Returns a single drug requisition. Accessible by `patient`, `pharmacy`, `consultant`, and `admin` roles.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Updates a drug requisition (e.g. status or quantity). Accessible by `patient`, `pharmacy`, and `admin` roles.',
  })
  @ApiParam({ name: 'id', description: 'UUID of the drug requisition to update.' })
  ...
  @ApiOperation({
    ...
    description: 'Cancels a pending drug requisition. Accessible by `patient` and `admin` roles.',
  })
  @ApiParam({ name: 'id', description: 'UUID of the drug requisition to cancel.' })
  ...
  @ApiOperation({
    ...
    description: 'Submits a request for a lab test, typically ordered by a consultant on behalf of a patient. Accessible by `patient`, `consultant`, and `admin` roles.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Returns a paginated list of test requisitions. Accessible by `patient`, `consultant`, `lab`, and `admin` roles.',
  })
  @ApiResponse({ status: 200, description: 'Paginated list of test requisitions.' })
  @ApiResponse({ status: 401, description: 'Missing or invalid token.' })
  ...
  @ApiOperation({
    ...
    description: 'Returns a single test requisition. Accessible by `patient`, `consultant`, `lab`, and `admin` roles.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Updates a test requisition (e.g. result status or notes). Accessible by `patient`, `consultant`, `lab`, and `admin` roles.',
  })
  @ApiParam({ name: 'id', description: 'UUID of the test requisition to update.' })
  ...
  @ApiOperation({
    ...
    description: 'Cancels a pending test requisition. Accessible by `patient`, `consultant`, and `admin` roles.',
  })
  @ApiParam({ name: 'id', description: 'UUID of the test requisition to cancel.' })
